    ...
    <div className="bg-temple-ivory min-h-screen flex flex-col pb-20">
      ...
      <header className="w-full top-0 sticky bg-surface z-40 border-b border-outline-variant/20">
        <div className="flex justify-between items-center px-4 py-2">
          ...
          <button className="text-madder-red active:scale-95 p-2 rounded-full" aria-label="More options">
      ...
      <button
        onClick={() =>
          activeTab === 'tasks'
            ? navigate('/areas/' + sectionId + '/new-task')
            : handleNewNote()
        }
        className="fixed bottom-[88px] right-6 w-14 h-14 bg-madder-red text-temple-ivory rounded-full shadow-[0_4px_20px_rgba(139,44,36,0.3)] flex items-center justify-center hover:bg-primary transition-colors active:scale-95 z-40"
