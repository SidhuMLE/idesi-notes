  ...
  return (
    <div className="bg-temple-ivory text-granite font-body-md antialiased min-h-screen pb-24 selection:bg-pandya-gold/20">
      ...
      <button
        ...
        className="fixed bottom-24 right-4 w-14 h-14 bg-madder-red text-temple-ivory rounded-2xl shadow-[0_8px_24px_rgba(139,44,36,0.3)] flex items-center justify-center hover:-translate-y-1 transition-transform active:scale-95 z-40"
      ...
      {showQuickAdd && (
        <div className="fixed inset-0 z-50 flex items-end">
          ...
          <div
            ...
            className="absolute inset-0 bg-granite/20"
          />
          <div className="relative w-full bg-surface rounded-t-2xl p-6 space-y-4 shadow-[0_-8px_32px_rgba(34,30,26,0.12)]">
            <div className="w-8 h-1 bg-outline-variant rounded-full mx-auto mb-2" />
            <h3 className="font-headline-sm text-headline-sm text-granite">Quick Add Task</h3>
