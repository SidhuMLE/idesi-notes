  ...
  return (
    <div className="bg-temple-ivory min-h-screen pb-16">
      ...
      <header className="w-full top-0 sticky bg-surface border-b border-outline-variant/20 z-50 flex justify-between items-center px-4 py-2">
        <button
          onClick={() => navigate(-1)}
          className="text-madder-red hover:text-primary active:scale-95 p-2 -ml-2 rounded-full"
        >
        ...
        <button
          ...
          className="text-madder-red active:scale-95 p-2 -mr-2 rounded-full"
        >
      ...
      {showDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div onClick={() => setShowDelete(false)} className="absolute inset-0 bg-granite/30" />
          <div className="relative bg-surface rounded-2xl p-6 w-full max-w-sm space-y-4 shadow-xl">
            <h3 className="font-headline-sm text-headline-sm text-granite">Delete Task?</h3>
